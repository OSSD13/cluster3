    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="departmentFormAdd">
                    <div class="mb-3">
                        <label for="departmentNameAdd" class="form-label">ชื่อแผนก</label>
                        <input type="text" class="form-control" id="departmentNameAdd" placeholder="กรอกชื่อแผนก..." required>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-save" id="saveDepartmentAdd">บันทึก</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <form id="departmentFormEdit">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="departmentNameEdit" placeholder="กรอกชื่อแผนก..." required>
                        <div class="invalid-feedback">***กรุณากรอกข้อมูลให้ครบถ้วน</div>
                    </div>
                    <div class="confirmation-text">
