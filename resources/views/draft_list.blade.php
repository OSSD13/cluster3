...
* หน้าจอแสดงลิสต์แบบร่างใบสั่งงานเพื่อให้สามารถดูและแก้ไขได้ รวมไปถึงลบใบงานใหญ่ที่เป็นแบบร่างได้
* @input : draftRequests (รายการใบสั่งงานที่ดึงมาจากฐานข้อมูล)
* @output : ตารางของใบสั่งงานที่มีปุ่มแก้ไขและลบ.
